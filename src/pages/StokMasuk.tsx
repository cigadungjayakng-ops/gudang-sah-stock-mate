...
function StokMasukContent() {
  ...
  const fetchData = async () => {
    ...
    if (stockInRes.data) setStockInData(stockInRes.data);
  };
  ...
  const filteredStockInData = stockInData.filter((item) => {
    const matchesSearch =
    ...
    const matchesJenis = !filterJenis || item.jenis_stok_masuk_id === filterJenis;
  ...
  const paginatedData = filteredStockInData.slice(
        ...
        {userRole === "user" && (
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <Alert variant="destructive" className="mb-4">
              ...
              <AlertDescription>
                ⚠️ Setelah data diposting, tidak bisa dibatalkan.
              </AlertDescription>
            </Alert>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      setFormData({ ...formData, jenis_stok_masuk_id: value });
                      setSelectedJenis(getJenisName(value));
                    }}
                    required
                  >
                    <SelectTrigger>
            ...
            {paginatedData.length === 0 ? (
              <TableRow>
                <TableCell colSpan={6} className="text-center">
                  {stockInData.length === 0 ? "Belum ada data stok masuk" : "Tidak ada data yang cocok"}
                </TableCell>
              </TableRow>
            ) : (
