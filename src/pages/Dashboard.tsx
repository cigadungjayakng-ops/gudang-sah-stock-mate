  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle>Selamat Datang di Gudang SAJ</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">
            Sistem manajemen stok gudang yang membantu Anda mengelola produk, stok masuk, dan stok keluar dengan mudah.
